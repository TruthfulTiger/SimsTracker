...
<p class="lead mb-3"><b>Sub total: <output id="bvtotal" for="bvt"><span
    <?php if ($s2legacy['bvtotal']  == 0): ?>class="badge badge-primary"<?php endif; ?>
    <?php if ($s2legacy['bvtotal']  > 0): ?>class="badge badge-success"<?php endif; ?>
    <?php if ($s2legacy['bvtotal']  < 0): ?>class="badge badge-danger"<?php endif; ?>>
