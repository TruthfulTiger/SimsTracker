<h3 class="text-primary"><?= ($cat) ?> <img src="<?= ($BASE) ?><?= ($s2path) ?>Seasons.png" alt="Needs Seasons"> <a href="#" class="badge badge-pill badge-secondary title" data-toggle="collapse" data-target="#snsHelp" aria-expanded="false" aria-controls="snsHelp">
	?</a>
	</a></h3>
<div class="collapse" id="snsHelp">
	<div class="card card-body">
		<dt>From SimsLegacyChallenge.com</dt>
		<dd><h6 class="text-primary">Legacy Tree</h6>
...
<div class="form-row">
    <div class="col">
        <div class="form-group">
            ...
            <input type="number" min="0" max="9" class="form-control sns" id="tree" value="<?= (trim($s2legacy['tree'])) ?>" name="tree"/>
        </div>
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input sns" value="1" name="fish" id="fish"
				<?php if ($s2legacy['fish'] == 1): ?>
					checked
				<?php endif; ?>
				/>
...
<p class="lead mb-3"><b>Sub total: <output id="seasonstotal" for="st"><span
    <?php if ($s2legacy['seasonstotal']  == 0): ?>class="badge badge-primary"<?php endif; ?>
    <?php if ($s2legacy['seasonstotal']  > 0): ?>class="badge badge-success"<?php endif; ?>
    <?php if ($s2legacy['seasonstotal']  < 0): ?>class="badge badge-danger"<?php endif; ?>>
