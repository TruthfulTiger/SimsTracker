<h3><?= ($cat) ?> <a href="#" class="badge badge-pill badge-secondary title" data-toggle="collapse" data-target="#snsHelp" aria-expanded="false" aria-controls="snsHelp">
	?</a>
	</a></h3>
...
<div class="form-row">
    <div class="col">
        <div class="form-group">
            ...
            <input type="number" min="0" class="form-control sets" id="alienpreg" value="<?= ($alienpreg) ?>" name="alienpreg"/>
        </div>
        <div class="form-group">
            <label for="platgraves">Platinum Grave Sets</label>
            <input type="number" min="0" class="form-control sets" id="platgraves" value="<?= ($platgraves) ?>" name="platgraves"/>
        </div>
        <div class="form-group">
            <label for="elixirs">Sets of 25 Unused Elixirs</label>
            <input type="number" min="0" class="form-control sets" id="elixirs" value="<?= ($elixirs) ?>" name="elixirs"/>
        </div>
        <div class="form-group">
            <div class="custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input sets" value="1" name="allwants" id="allwants" <?= ($allwantschk) ?>>
                <label class="custom-control-label" for="allwants">All Impossible Wants</label>
            </div>
            <div class="custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input sets" value="1" name="allbugs" id="allbugs" <?= ($allbugschk) ?>>
                <label class="custom-control-label" for="allbugs">Complete Bug Collection <img src="<?= ($BASE) ?><?= ($s2path) ?>FT.png" alt="Needs FT"></label>
            </div>
            <div class="custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input sets" value="1" name="allhobbies" id="allhobbies" <?= ($allawardsck) ?>>
            ...
            <div class="custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input sets" value="1" name="allcareers" id="allcareers" <?= ($allcareersck) ?>>
                <label class="custom-control-label" for="allcareers">Complete Set of Career Rewards</label>
            </div>
        </div>
    </div>
</div>
<input type="hidden" name="ct" id="ct" value="<?= ($setstotal) ?>">
<p class="lead"><b>Sub total: <output id="setstotal" name="setstotal" for="ct"><span
