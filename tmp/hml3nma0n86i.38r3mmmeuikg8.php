<h3><?= ($cat) ?> <img src="<?= ($BASE) ?><?= ($s2path) ?>OFB.png" alt="Needs OFB"> <a href="#" class="badge badge-pill badge-secondary title" data-toggle="collapse" data-target="#gravesHelp" aria-expanded="false" aria-controls="gravesHelp">
    ?</a>
    </a></h3>
