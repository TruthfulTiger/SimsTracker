        ...
        <div class="accordion" id="wants">
            <div class="card show">
                <div class="card-header" id="family">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-family" aria-expanded="true" aria-controls="coll-family">
                            Family
                        </button>
                    </h5>
                </div>
                    <div id="coll-family" class="collapse" aria-labelledby="family" data-parent="#wants">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" oninput="childrenChange(value)" min="0" value="<?= (trim($s2legacy['childrencount'])) ?>" id="childrencount" name="childrencount" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="grandkidscount">Have 30 Grandchildren</label>
                                <input type="number" oninput="gkChange(value)" min="0" value="<?= (trim($s2legacy['grandkidscount'])) ?>" id="grandkidscount" name="grandkidscount" class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
            <div class="card">
                <div class="card-header" id="wealth">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-wealth" aria-expanded="true" aria-controls="coll-wealth">
                            Wealth
                        </button>
                    </h5>
                </div>
                <div id="coll-wealth" class="collapse" aria-labelledby="wealth" data-parent="#wants">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" oninput="earnChange(value)" min="0" value="<?= (trim($s2legacy['earncount'])) ?>" id="earncount" name="earncount" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="opencount">Open 5 Level 10 Businesses <img src="<?= ($BASE) ?><?= ($s2path) ?>OFB.png" alt="Needs Open For Business"></label>
                            <input type="number" oninput="openChange(value)" min="0" value="<?= (trim($s2legacy['opencount'])) ?>" id="opencount" name="opencount" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="knowledge">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-knowledge" aria-expanded="true" aria-controls="coll-knowledge">
                            Knowledge
                        </button>
                    </h5>
                </div>
                <div id="coll-knowledge" class="collapse" aria-labelledby="knowledge" data-parent="#wants">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" oninput="skillsChange(value)" min="0" value="<?= (trim($s2legacy['skillscount'])) ?>" id="skillscount" name="skillscount" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="alienscount">Be Abducted 3 Times</label>
                            <input type="number" oninput="aliensChange(value)" min="0" value="<?= (trim($s2legacy['alienscount'])) ?>" id="alienscount" name="alienscount" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="popularity">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-popularity" aria-expanded="true" aria-controls="coll-popularity">
                            Popularity
                        </button>
                    </h5>
                </div>
                <div id="coll-popularity" class="collapse" aria-labelledby="popularity" data-parent="#wants">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" oninput="bestiesChange(value)" min="0" value="<?= (trim($s2legacy['bestiescount'])) ?>" id="bestiescount" name="bestiescount" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="romance">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-romance" aria-expanded="true" aria-controls="coll-romance">
                            Romance
                        </button>
                    </h5>
                </div>
                <div id="coll-romance" class="collapse" aria-labelledby="romance" data-parent="#wants">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" oninput="lovesChange(value)" min="0" value="<?= (trim($s2legacy['lovescount'])) ?>" id="lovescount" name="lovescount" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="woohoocount">WooHoo 30 Sims</label>
                            <input type="number" oninput="woohooChange(value)" min="0" value="<?= (trim($s2legacy['woohoocount'])) ?>" id="woohoocount" name="woohoocount" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="pleasure">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-pleasure" aria-expanded="true" aria-controls="coll-pleasure">
                            Pleasure <img src="<?= ($BASE) ?><?= ($s2path) ?>NL.png" alt="Needs Nightlife"><img src="<?= ($BASE) ?><?= ($s2path) ?>OFB.png" alt="Needs OFB"><img src="<?= ($BASE) ?><?= ($s2path) ?>Pets.png" alt="Needs Pets"><img src="<?= ($BASE) ?><?= ($s2path) ?>Seasons.png" alt="Needs Seasons"><img src="<?= ($BASE) ?><?= ($s2path) ?>BV.png" alt="Needs BV"><img src="<?= ($BASE) ?><?= ($s2path) ?>FT.png" alt="Needs FT"><img src="<?= ($BASE) ?><?= ($s2path) ?>AL.png" alt="Needs AL">
                        </button>
                    </h5>
                </div>
                <div id="coll-pleasure" class="collapse" aria-labelledby="pleasure" data-parent="#wants">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" oninput="firstdatesChange(value)" min="0" value="<?= (trim($s2legacy['firstdatescount'])) ?>" id="firstdatescount" name="firstdatescount" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="dreamdatescount">Have 100 Dream Dates</label>
                            <input type="number" oninput="dreamdatesChange(value)" min="0" value="<?= (trim($s2legacy['dreamdatescount'])) ?>" id="dreamdatescount" name="dreamdatescount" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="cheese">
                    <h5>
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#coll-cheese" aria-expanded="true" aria-controls="coll-cheese">
                            Grilled Cheese <img src="<?= ($BASE) ?><?= ($s2path) ?>NL.png" alt="Needs Nightlife"><img src="<?= ($BASE) ?><?= ($s2path) ?>OFB.png" alt="Needs OFB"><img src="<?= ($BASE) ?><?= ($s2path) ?>Pets.png" alt="Needs Pets"><img src="<?= ($BASE) ?><?= ($s2path) ?>Seasons.png" alt="Needs Seasons"><img src="<?= ($BASE) ?><?= ($s2path) ?>BV.png" alt="Needs BV"><img src="<?= ($BASE) ?><?= ($s2path) ?>FT.png" alt="Needs FT"><img src="<?= ($BASE) ?><?= ($s2path) ?>AL.png" alt="Needs AL">
                        </button>
                    </h5>
                </div>
                <div id="coll-cheese" class="collapse" aria-labelledby="cheese" data-parent="#wants">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" oninput="sarniesChange(value)" min="0" value="<?= (trim($s2legacy['sarniescount'])) ?>" id="sarniescount" name="sarniescount" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
...
<p class="lead mt-3"><b>Sub total: <output id="wantstotal" for="wt"><span
    <?php if ($s2legacy['wantstotal']  == 0): ?>class="badge badge-primary"<?php endif; ?>
    <?php if ($s2legacy['wantstotal']  > 0): ?>class="badge badge-success"<?php endif; ?>
    <?php if ($s2legacy['wantstotal']  < 0): ?>class="badge badge-danger"<?php endif; ?>>
